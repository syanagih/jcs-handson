...
DEFINE pass     = Welcome1#
DEFINE tbs      = users
DEFINE ttbs     = temp
DEFINE pass_sys = Welcome1#
DEFINE log_path = /u01/app/oracle/product/12.1.0/dbhome_1/log/
DEFINE pdb_name = PDB1
PROMPT
...
CONNECT sys/&pass_sys@&pdb_name AS SYSDBA;
